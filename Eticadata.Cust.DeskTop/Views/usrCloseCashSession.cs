...
namespace Eticadata.Cust.DeskTop.Views
{
    public partial class usrCloseCashSession : Form
    {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            int activePOS = etiApp.AmbientePOS.Workstation.Code;
            ...
            movCaixas.GetSessaoCaixa(activePOS, activeUser, activeSession, activeFiscalYear,
                                    ...
                                    ref permissionEditDocs, ref provisoryClose, ref comissionType, ref docComission, ref pWokingDayCode); //Get active session
            ...
            if (movCaixaClose.IsNew) //If cash Session is open...
            {
                ...
                movCaixaClose.SetSessaoCaixa(movCaixaOpen.Cabecalho.AbrevTpDoc, movCaixaOpen.Cabecalho.Numero, movCaixaOpen.Cabecalho.SalesComissionType, movCaixaOpen.Cabecalho.DocComissionType, pWokingDayCode);
                movCaixaClose.Cabecalho.SessaoFechada = true;

                for (int i = 1; i < movCaixaClose.Lines.Count; i++)
                {
                    if (movCaixaClose.Lines[i].CodContaTesMeioPag == "NUM")
